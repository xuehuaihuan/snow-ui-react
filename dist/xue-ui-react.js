...
(function (global, factory) {
  ...
  (global = global || self, factory(global.XueUIReact = {}, global.React, global.PropTypes, global.styled));
...
`;
  ...
  var Ripple = /*@__PURE__*/(function (Component) {
    function Ripple(props) {
      ...
      _defineProperty(this, "getRef", function (node) {
        this$1.rippleNode = node;
      });

      _defineProperty(this, "ripple", function (event, element) {
      ...
      _defineProperty(this, "handleTouchStart", function (event) {
        ...
        this$1.setState(function () { return ({
          children: children
        }); }, function () {
      ...
      _defineProperty(this, "handleAnimationEnd", function (key) {
    ...
    Ripple.prototype.render = function render () {
      ...
      var otherProps = rest;
      return /*#__PURE__*/React__default.createElement(StyledRipple, otherProps, /*#__PURE__*/React__default.createElement("div", {
        className: RIPPLE_LIST_CLASS,
        ref: this.getRef
      }, this.state.children.map(function (child) {
        return /*#__PURE__*/React__default.createElement(StyledRippleItem, {
          key: child,
          onAnimationEnd: function () { return this$1.handleAnimationEnd(child); }
        });
      })), children);
    };
