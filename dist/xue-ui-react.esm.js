...
var Ripple = /*@__PURE__*/(function (Component) {
    ...
    Ripple.prototype.render = function render () {
        ...
        return (React.createElement(StyledRipple, Object.assign({}, otherProps),
            React.createElement("div", { className: RIPPLE_LIST_CLASS, ref: this.getRef }, (this.state.children).map(function (child) {
                return (React.createElement(StyledRippleItem, { key: child, onAnimationEnd: function () { return this$1.handleAnimationEnd(child); } }));
            })),
            children));
    };
